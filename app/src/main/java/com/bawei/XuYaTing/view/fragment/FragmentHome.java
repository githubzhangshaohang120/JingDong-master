...
import com.bawei.XuYaTing.presenter.FragmentHomeP;
import com.bawei.XuYaTing.util.ApiUtil;
import com.bawei.XuYaTing.util.ChenJinUtil;
import com.bawei.XuYaTing.util.GlideImageLoader;
import com.bawei.XuYaTing.view.Iview.InterFragmentHome;
import com.bawei.XuYaTing.view.Iview.OnItemListner;
import com.bawei.XuYaTing.view.activity.CustomCaptrueActivity;
import com.bawei.XuYaTing.view.activity.DetailActivity;
import com.bawei.XuYaTing.view.activity.WebViewActivity;
import com.bawei.XuYaTing.view.adapter.HengXiangAdapter;
import com.bawei.XuYaTing.view.adapter.MiaoShaAdapter;
import com.bawei.XuYaTing.view.adapter.TuiJianAdapter;
import com.bawei.XuYaTing.view.custom.ObservableScrollView;
...
public class FragmentHome extends Fragment implements InterFragmentHome{
    ...
    private void initMarqueeView() {
        ...
        info.add("新品上市，快来抢购吧");
        info.add("好东西，你值得拥有");
        info.add("今日8.8折，你还在等什么");
        info.add("轻奢商品即将上架，快来围观吧");
        info.add("还有还什么是你想不到的呢");
